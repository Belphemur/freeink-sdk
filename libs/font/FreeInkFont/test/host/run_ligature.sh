...
# freetype-config overlay first: it carries this library's curated ftmodule.h
# (the submodule's default module list registers renderers whose wrapper TUs
# are not all compiled here, which fails at link time).
