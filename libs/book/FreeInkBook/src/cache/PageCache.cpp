...
constexpr uint16_t kFormatVersion = 5;  // v5: ruby annotation records (v4: rule records; v3: link records + anchor table)
...
constexpr uint32_t kLayoutRevision = 11;  // 11: ruby lines drop ascender/2, annotations render
